  ...
  return (
    <section className="overflow-x-auto">
      ...
      <main className="mt-16  bg-black text-white">
        ...
        <section className="flex flex-col gap-y-8 items-center justify-center pt-20" data-aos="fade-up"
          ...
          <p className="text-center font-extralight text-sm lg:px-56">
            ...
            marketplace. Leveraging cutting-edge blockchain technology on XION,
            we’re bringing a new level of gaming accessibility to
          ...
          <article className="flex gap-x-4 relative z-20">
            <button className="bg-[#5856D6] w-[140px] flex justify-center items-center gap-x-2 rounded-lg  " data-aos="fade-right"
            data-aos-easing="ease-out"
            data-aos-duration="1200"
            data-aos-once="true">
            ...
            <button className="border-[#5856D6] w-[140px] h-[48px]  border flex  items-center  rounded-lg text-center justify-center" data-aos="fade-left"
            data-aos-easing="ease-out"
            data-aos-duration="1200"
            data-aos-once="true">
              Faucet
        ...
        <section className="mx-auto flex justify-center mt-10 relative z-20 " data-aos="fade-up"
            data-aos-easing="ease-out"
            data-aos-duration="1200"
            data-aos-once="true">
          <Image
        ...
        <section className="mt-10 flex flex-col gap-y-4 lg:flex-row lg:flex-wrap lg:justify-center lg:gap-x-10">
          <article className="flex flex-col gap-y-3 border bg-[#0B0D2775] border-[#061C3D] rounded-lg p-4 w-[327px] h-[143px]" data-aos="fade-up"
            data-aos-easing="ease-out"
            data-aos-duration="1200"
            data-aos-once="true">
